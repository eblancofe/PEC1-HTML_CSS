...
/* Función JS que ocupa menos código que la implantación de DayJS (caso concreto...)
function startTime(){
  today=new Date();
...
*/ function empieza_Tiempo() {
    today = new Date();
    (0, _dayjsDefault.default)(today);
    (0, _dayjsDefault.default).locale("es");
    (0, _dayjsDefault.default).extend((0, _localeDataDefault.default));
    (0, _dayjsDefault.default).weekdays();
    (0, _dayjsDefault.default).months();
    salida_fecha = (0, _dayjsDefault.default)().format("dddd, D [de] MMMM [de] YYYY (DD/MM/YYYY)  "); //formato fecha
    salida_hora = (0, _dayjsDefault.default)().format("HH:mm:ss  "); //formato hora
...
},{"dayjs":"NJZFB","dayjs/locale/es":"anAVg","dayjs/plugin/localeData":"31yM4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"NJZFB":[function(require,module,exports) {
!function(t, e) {
    module.exports = e();
}(this, function() {
    "use strict";
...
!function(e, o) {
    module.exports = o(require("141c22994cac1cec"));
}(this, function(e) {
    "use strict";
    function o(e) {
...
},{"141c22994cac1cec":"NJZFB"}],"31yM4":[function(require,module,exports) {
!function(n, e) {
    module.exports = e();
}(this, function() {
    "use strict";
...
},{}]},["gbXMy","bNKaB"], "bNKaB", "parcelRequiree209")
